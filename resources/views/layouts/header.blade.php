 <div id="header">
            ...
            <div class="container">
                <div class="pull-left auto-width-left">
                    <ul class="top-menu menu-beta l-inline">
                        <li><a href=""><i class="fa fa-home"></i> Nam Thành, Yên Thành, Nghệ An</a></li>
                        <li><a href=""><i class="fa fa-phone"></i> 0964 99 12 98</a></li>
                    </ul>
                </div>
        ...
        <div class="header-body">
            <div class="container beta-relative">
                <div class="pull-left">
                    <a href="/" id="logo"><img src="{{ asset('assets/dest/images/logo-cake.png') }}" width="200px" alt=""></a>
                </div>
